	...
	public boolean equals(Object obj) {
		try {
			...
			if(media instanceof Media) {
				...
				if((this.title.equalsIgnoreCase(media.title)) && (this.cost == media.cost)) return true;
				else return false;
			}else {
			...
			System.err.println("NullPoiter is not valid!");
			return false;
		} catch (ClassCastException e) {
			System.err.println("Cannot cast to Media class!");
			return false;
		}
